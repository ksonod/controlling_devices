function [ima_stack,errorCode] = pco_sdk_example_recorder(imacount,exposure_time,triggermode)
...
[errorCode,ima_stack]=pco_recorder_copy_images(hrec_ptr,hcam_ptr,imacount,uint16(cam_desc.wDynResDESC));
